  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-24 pb-16 md:pt-32 md:pb-20 overflow-hidden bg-transparent">
      ...
      <motion.div
        ...
        className="absolute top-[15%] left-2 sm:left-[2%] xl:left-[8%] p-4 sm:p-6 potion-glass rounded-2xl sm:rounded-3xl rotate-[-12deg] z-20 opacity-100 sm:opacity-40 xl:opacity-100 transition-all scale-90 sm:scale-90 xl:scale-100"
      >
      ...
      <motion.div
        ...
        className="absolute bottom-[18%] right-2 sm:right-[2%] xl:right-[8%] p-4 sm:p-6 potion-glass rounded-2xl sm:rounded-3xl rotate-[8deg] z-20 opacity-100 sm:opacity-40 xl:opacity-100 transition-all scale-90 sm:scale-90 xl:scale-100"
      >
        <div className="flex items-center gap-2 sm:gap-3">
