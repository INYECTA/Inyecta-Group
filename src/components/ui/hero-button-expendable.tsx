      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-white dark:bg-zinc-950 px-4 sm:px-6 py-12 sm:py-20 transition-colors duration-300">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 sm:gap-8 text-center">
          ...
          >
            ...
            Nuevo: Sistema de Automatización 2024
          </motion.div>
          ...
          >
            Automatización que llena tu <br className="hidden sm:block" />
          ...
          >
            Convierte consultas de Instagram y WhatsApp en citas confirmadas sin que tu equipo haga nada. 
            Inyecta Group proporciona la infraestructura para escalar tu clínica estética.
          </motion.p>
                ...
                <div className="flex-1 flex flex-col justify-center p-8 sm:p-12 lg:p-16 gap-8 text-white">
                  <div className="space-y-4">
                    ...
                    <p className="text-blue-100 text-lg max-w-md">
                      Únete a las clínicas estéticas que ya están automatizando su crecimiento con Inyecta Group.
                    </p>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex gap-4 items-start">
                      ...
                      <div>
                        <h3 className="font-semibold text-lg">Análisis de Datos</h3>
                        <p className="text-blue-100/80 text-sm leading-relaxed mt-1">
                          Insights en tiempo real sobre tus leads y conversiones.
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-4 items-start">
                      ...
                      <div>
                        ...
                        <p className="text-blue-100/80 text-sm leading-relaxed mt-1">
                          Gestiona múltiples sedes desde un solo panel de control.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-auto pt-8 border-t border-white/20">
                    <figure>
                      <blockquote className="text-xl font-medium leading-relaxed mb-6">
                        "Inyecta Group transformó cómo gestionamos las citas. Pasamos de perder leads a tener la agenda llena todos los días."
                      </blockquote>
                      <figcaption className="flex items-center gap-4">
                        <div className="h-12 w-12 rounded-full bg-gradient-to-tr from-blue-400 to-cyan-500 flex items-center justify-center text-lg font-bold text-white">
                          IG
                        </div>
                        <div>
                          <div className="font-semibold">Dra. Marta Sánchez</div>
                          <div className="text-sm text-blue-200">Directora Médica, Clínica Estética</div>
                        </div>
                      </figcaption>
                    </figure>
                  </div>
                    ...
                    {formStep === "success" ? (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-blue-100">Nuestro equipo se pondrá en contacto contigo pronto para agendar tu auditoría.</p>
                        </div>
                        <button 
                          onClick={handleClose}
                      ...
                      <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="space-y-1">
                          <h3 className="text-xl font-semibold text-white">Solicitar Auditoría</h3>
                          <p className="text-sm text-blue-200">Completa el formulario y te contactaremos.</p>
                        </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              >
                                <option className="bg-blue-900">1-5 empleados</option>
                                <option className="bg-blue-900">6-20 empleados</option>
                                <option className="bg-blue-900">21-50 empleados</option>
                                <option className="bg-blue-900">50+</option>
                              </select>
                            </div>
                          </div>
                        ...
                        <p className="text-xs text-center text-blue-200/60 mt-4">
                          Al enviar, aceptas nuestros Térmos de Servicio y Política de Privacidad.
                        </p>
                      </form>
                    )}
                  </div>
