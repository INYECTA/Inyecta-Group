    ...
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      {!isMobile ? (
        ...
        <>
          ...
          <div className="absolute -top-[10%] -left-[5%] w-[70%] h-[70%] rounded-full bg-gradient-to-br from-blue-200/20 to-transparent blur-[80px]" />
          <div className="absolute top-[30%] -right-[10%] w-[60%] h-[60%] rounded-full bg-gradient-to-bl from-blue-100/10 to-transparent blur-[100px]" />
        </>
      )}
      
      {/* Texture & Grid */}
      <div className="absolute inset-0 bg-grid opacity-[0.04]"></div>
      {!isMobile && <div className="absolute inset-0 bg-noise opacity-[0.03]"></div>}

      {/* GodRays - Very subtle, disabled on mobile */}
      {!isMobile && (
